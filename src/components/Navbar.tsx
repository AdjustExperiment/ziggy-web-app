...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-none">
      <div className="absolute inset-0 backdrop-blur-xl bg-white/10 dark:bg-black/10"></div>
      <div className="absolute inset-x-0 top-0 h-24 backdrop-blur-xl bg-gradient-to-b from-white/15 via-white/8 to-transparent dark:from-black/15 dark:via-black/8 dark:to-transparent"></div>
