...
// Shuffled list for diagnostic testing - cities interleaved from all continents
// to determine if missing markers are due to quantity limit vs region bug
export const WORLD_CITIES: City[] = [
  // Batch 1: One from each region
